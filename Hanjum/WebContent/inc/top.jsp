...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="index.html"><span>한줌</span>에디터</a>
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item <%if(request.getServletPath().contains("board")){ %>active<% } %>"><a href="BoardList.bo" class="nav-link">Enterprise</a></li>
