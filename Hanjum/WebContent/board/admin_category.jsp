...
function add_txt(){
	 document.getElementById("add_text").innerHTML +=
	"<form action ='CategoryWritePro.cg' method='post'>"
	 + "<input type='text' name='category_content' id='textbox'>"
...
<table class="table1" >
	<form method="post">
	<tr>
		<td><input type="text" value="<%=category_content%>" id="textbox"
		...
		<td><input type="submit" value='수정' formaction="CategoryUpdate.cg" name="fix" class="category_button"></td>
		<td><input type='submit' value='삭제' formaction="CategoryDelete.cg" name="delete" class="category_button"></td>
	</tr>
	</form>
</table>
<%}%>
<input type="button" value="새 카테고리 추가" onclick="add_txt()" class="category_button"><br>
</div>
