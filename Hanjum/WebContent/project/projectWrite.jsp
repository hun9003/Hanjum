...
<div class="write_form">
					...
					<tr><th class="td_name"><label for="Subject">프로젝트 제목</label></th><td class="td_content"><div class="input_subject"><input id="Subject" type="text" name="board_subject" required="required"></div></td></tr>
					<tr><th class="td_name"><label for="Content">프로젝트 소개</label></th><td class="td_content"><textarea id="Content" name="board_content" cols="100" rows="5" ></textarea></td></tr>
