...
<form action="ProjectUpdatePro.bo" method="post" name="fr_write" id="UpdateForm" onsubmit="return false">
<input type="hidden" name="board_id" value="<%=project.getBoard_id()%>">
<table class="write_table">
<tr><th class="td_name"><label for="Subject">프로젝트 제목</label></th><td class="td_content"><div class="input_subject"><input id="Subject" type="text" name="board_subject" required="required" value="<%=project.getBoard_subject()%>"></div></td></tr>
<tr><th class="td_name"><label for="Content">프로젝트 소개</label></th><td class="td_content"><textarea id="Content" name="board_content" cols="100" rows="5" ><%=project.getBoard_content()%></textarea></td></tr>
<tr><th class="td_name">장르</th><td class="td_content">
...
<tr><th class="td_name"><label for="DetailContent">세부설명</label></th><td class="td_content">
<textarea id="DetailContent" name="board_creator_content_detail"><%=project.getBoard_creator_content_detail() %></textarea>
</td></tr>
<tr><th class="td_name">동시 녹음 유무</th><td class="td_content">
...
<tr><th class="td_name">녹화에 이용된 캠</th><td class="td_content">
...
<tr><th class="td_name">원본 클립</th><td class="td_content">
...
<tr><th class="td_name">편집 전 런타임</th><td class="td_content">
...
<tr><th class="td_name">편집 후 런타임</th><td class="td_content">
...
<tr><th class="td_name"><label for="OriTransfer1">파일의 전달방식</label></th><td class="td_content">
...
<tr><th class="td_name"><label for="MinPrice">예상 단가</label></th><td class="td_content">
...
<tr><th class="td_name"><label for="Ref1">레퍼런스 링크</label></th>
...
<div class="write_form_submit"><input type="submit" id="UpdateSubmit" name="update-submit" value="수정하기"></div>
</form>
</div>
<%
}
